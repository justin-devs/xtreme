         ...
         {!! Form::model($vehicle, array('route' => array('vehicles.update', $vehicle->id), 'method' => 'PUT')) !!} 
          ...
          <div class="form-group">
            ...
            @if(count($vehicle->customer))
              {!! Form::select('customer_id', $customers, $vehicle->customer->name,['class' => 'form-control'] ) !!}
            @else
          ...
          <div class="form-group">
            ...
            {{Form::text('registration',$vehicle->registration, ['class' => 'form-control', 'placeholder' => 'Registration'])}}
          </div>
...
<script type="text/javascript">
  var vehicle = {!! json_encode($vehicle->toArray()) !!};
$(document).ready(
function()
{
      console.log(vehicle);
     ...
     carquery.init(vehicle.year, vehicle.make, vehicle.model,'');
